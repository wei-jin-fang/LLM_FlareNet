...
from tools import BS_BSS_score, BSS_eval_np, save_csv
...
parser.add_argument('--num_heads', type=int, default=8)#大模型层
        ...
        for _modelType in ["NN"]:
            ...
            with open(results_filepath, 'w') as results_file:
                ...
                for count1 in range(args.num_dataset + 1):  # 循环处理0-9个数据集
                    ...
                    model_filename = rf"G:\本科\项目_比赛_论文资料\论文_LLM_VIT\Titan\BSS" \
                                     + f"\BSS_{args.model_type}" + f"\model_{count}.pt"
                    ...
                    path = fr"BSS_40-40_{args.model_type}_{count}"
                    save_csv(y_pred, y_true, "BSSCSV",path)
