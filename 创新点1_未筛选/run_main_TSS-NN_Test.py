        ...
        for _modelType in ["NN"]:
            ...
            with open(results_filepath, 'w') as results_file:
                ...
                results = {
                    ...
                    "Mean": [data_Recall.mean(axis=0), data_Precision.mean(axis=0),
                             data_Accuracy.mean(axis=0),
                             data_TSS.mean(axis=0), data_HSS.mean(axis=0),
                             data_FAR.mean(axis=0), data_BSS.mean(axis=0),
                             data_FPR.mean(axis=0)],
                    "Std": [data_Recall.std(axis=0), data_Precision.std(axis=0),
                            data_Accuracy.std(axis=0),
                            data_TSS.std(axis=0), data_HSS.std(axis=0),
                            data_FAR.std(axis=0), data_BSS.std(axis=0),
                            data_FPR.std(axis=0)]
                }
