    ...
    '''
            补充：加载测试集
                    ...
                    LIME也找找
                        ...
                        最新版决策图
    '''
    plot_type = "dot"  # dot点图 bar条形图

    shap.summary_plot(shap_values_positive_mean, data_x_mean, feature_names=feature_names, plot_type=plot_type)

    # 保存图形
    filename = fr"E:\conda_code_tf\LLM\LLM_VIT\创新点整理版本\创新点1-特征重要性分析\未筛选\tesing\{plot_type}\{plot_type}-{model_typ}-positive_class-{classnumber}-summary_plot-{count}.png"
