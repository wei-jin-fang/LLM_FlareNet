...
def globaldata():
    ...
    # 读取新的CSV文件
    new_csv_path = "./ccmc_fits提取_筛选.csv"  # 替换为新CSV文件的路径
    ...
    # 保存归一化后的数据到新的CSV文件
    output_csv_path = "../创新点2_对比ccmc_先平均无标准差_筛选/scaler_ccmc_fits提取_筛选.csv"  # 设置输出文件的路径
...
def duiqiOneandMPLus(JianceType,datasetnumber):
    ...
    original_df = pd.read_csv("../创新点2_对比ccmc_先平均无标准差_筛选/scaler_ccmc_fits提取_筛选.csv")
...
def calculate_metrics_stats(tenmodelallMetricList,JianceType,ProName):
    ...
    if best_threshold:
        ...
        # 添加阈值信息作为单独一列
        df.insert(0, 'Threshold', f"Threshold {best_threshold}")
...
if __name__ == '__main__':
    ...
    # globaldata()
    print("=============================================================测试数据集========================================================")
    # mainTestdataFile(["LLM_VIT"],"../创新点2_对比ccmc_先平均无标准差_筛选/scaler_ccmc_fits提取_筛选.csv","TSS")
    # mainTestdataFile(["LLM_VIT"],"../创新点2_对比ccmc_先平均无标准差_筛选/scaler_ccmc_fits提取_筛选.csv","BSS")
    # exit()
