...
def globaldata():
    ...
    # 保存归一化后的数据到新的CSV文件
    output_csv_path = "../创新点2_对比sr_先平均无标准差_筛选/scaler_sr_fits提取_筛选.csv"  # 设置输出文件的路径
...
def duiqiOneandMPLus(JianceType,datasetnumber):
    ...
    original_df = pd.read_csv("../创新点2_对比sr_先平均无标准差_筛选/scaler_sr_fits提取_筛选.csv")
...
if __name__ == '__main__':
    ...
    # globaldata()
    # print("=============================================================测试数据集========================================================")
    # mainTestdataFile(["LLM_VIT"],"../创新点2_对比sr_先平均无标准差_筛选/scaler_sr_fits提取_筛选.csv","TSS")
    # mainTestdataFile(["LLM_VIT"],"../创新点2_对比sr_先平均无标准差_筛选/scaler_sr_fits提取_筛选.csv","BSS")
    # # exit()
