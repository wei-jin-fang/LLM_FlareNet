...
from pymysql_util import insert_event_data
...
def getFixedEventalldata(start_date):
    ...
    return target_value, prev_value


def getEventFixed_dayurl(year,start_date_str,start_date_event_key):
...
def getTodayEvent():
    ...
    url = f"https://www.lmsal.com/solarsoft/last_events/"
    response = requests.get(url)
...
if __name__ == '__main__':
    ...
    start_date_event_key,pre_date_event_key=(getFixedEventalldata(start_date_str))#{'20250429': '2359', '20250428': '2359'
    print(start_date_event_key,pre_date_event_key)
    exit()
    print(getEventFixed_dayurl(year,start_date_str,start_date_event_key))
