...
def globaldata():
    ...
    # 保存归一化后的数据到新的CSV文件
    output_csv_path = "./scaler_ccmc_fits提取_未筛选.csv"  # 设置输出文件的路径
...
def duiqiOneandMPLus(JianceType):
    ...
    '''
    average_probabilities_with_noaaid
    主要是这个文件方便对齐
    '''
    ...
    original_df = pd.read_csv("./scaler_ccmc_fits提取_未筛选.csv")
...
if __name__ == '__main__':
    ...
    # globaldata()
    print("=============================================================测试数据集========================================================")
    # mainTestdataFile(["LLM_VIT"],"./scaler_ccmc_fits提取_未筛选.csv","TSS")
    # mainTestdataFile(["LLM_VIT"],"./scaler_ccmc_fits提取_未筛选.csv","BSS")
